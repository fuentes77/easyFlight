...
public class ServiceManagement{
	...
	public boolean registerUser(String username, String password, String email, String usertyp){
		...
		try{
			...
			st.executeUpdate("INSERT INTO user(username, password, email, usertyp) VALUES('"+username+"', '"+password+"', '"+email+"', '"+usertyp+"')");
	...
	public boolean nachrichtSenden(String von, String text){
		Connection conn=null;
		Statement st=null;
		try{
			Class.forName(driver).newInstance();
			...
			Date datum=new Date();
			String stringDatum=mask.format(datum);
			
			st.executeUpdate("INSERT INTO nachricht(von, text, datum) VALUES('"+von+"', '"+text+"', '"+stringDatum+"')");
